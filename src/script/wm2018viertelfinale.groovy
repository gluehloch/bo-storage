...
def wm2018_viertelfinale = service.addGroup wm2018, viertelfinale
println "Viertelfinale: $wm2018_viertelfinale.id"
...
printTeams(wm2018_viertelfinale)


def round_2018_07_06 = service.findRound(wm2018, 19)
if (round_2018_07_06.isPresent()) {
    round_2018_07_06 = round_2018_07_06.get()
} else {
    round_2018_07_06 = service.addRound(wm2018, '2018-07-06 16:00:00', viertelfinale)
}
println "Runde $round_2018_07_06.dateTime"

def round_2018_07_07 = service.findRound(wm2018, 20)
