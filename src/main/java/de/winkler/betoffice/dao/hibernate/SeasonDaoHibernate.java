/*
 * $Id: SeasonDaoHibernate.java 3782 2013-07-27 08:44:32Z andrewinkler $
 * ============================================================================
...
public class SeasonDaoHibernate extends AbstractCommonDao<Season> implements
    ...
    public List<TeamResult> calculateTeamRanking(Season season, Group group) {
        ...
        queryTeamGoals.setParameter("group_id", group.getId());
        ...
        queryTeamPoints.setParameter("group_id", group.getId());
    ...
    private List<TeamResult> teamResultToList(
            final Map<Team, TeamResult> teamResults) {
