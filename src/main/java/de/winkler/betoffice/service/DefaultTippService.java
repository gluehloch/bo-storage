/*
 * $Id: DefaultTippService.java 3875 2013-12-26 16:06:25Z andrewinkler $
 * ============================================================================
 ...
 * @version $LastChangedRevision: 3875 $ $LastChangedDate: 2013-11-29 22:36:13
 *          +0100 (Fr, 29 Nov 2013) $
 */
@Service("tippService")
public class DefaultTippService extends AbstractManagerService implements
	...
	public void sendMailTipp(User user, TippMailParameter tippMailParameter) {
		...
		GameList round = getConfig().getRoundDao().findRound(season, roundNr - 1);
		if (round == null) {
	...
	public List<GameTipp> findTippsByRoundAndUser(long seasonId, long roundId,
		...
		return getConfig().getGameTippDao().findTippsByRoundAndUser(seasonId,
				roundId, nickname);
	}
	...
	public GameList findNextTippRound(Season season, DateTime date) {
		...
		Long roundId = roundDao.findNextTippRound(season, date);
		if (roundId != null) {
