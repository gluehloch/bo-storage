/*
 * $Id: SeasonManagerService.java 3849 2013-11-29 21:36:13Z andrewinkler $
 * ============================================================================
...
public interface SeasonManagerService {
     ...
     *
     * @param season Die betreffende Meisterschaft.
     * @param startIndex Index des Spieltags ab dem gezählt wird.
     * @param endIndex Index des Spieltags bis zu dem gezählt wird.
     * @return Das Ranking der Tipper.
     */
     ...
     *
     * @param season Die Spieltage dieser Meisterschaft werden geladen.
     ...
     *
     * @param season Die betreffende Meisterschaft.
     * @param users Die zu aktivierenden Teilnehmer.
     */
     ...
     *
     * @param season Die betreffende Meisterschaft.
     * @param users Die zu deaktivierenden Teilnehmer.
     */
     ...
     * @param date Datum des Spieltags. Einzelne Spielpaarungen können von
     *     diesem Datum abweichen!
     * @param groupType Spieltag einer Gruppe? Dieser Wert ist optional und
     *     kann für einzelne Spielpaarungen des Spieltags abweichen!
    ...
    /**
     * Eine neue Spielpaarung der Meisterschaft hinzufügen. Das Spiel gilt
     * als beendet.
     *
     * @param round Der Spieltag.
     * @param date Datum des Spiels.
