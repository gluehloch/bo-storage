/*
 * $Id: TeamType.java 3782 2013-07-27 08:44:32Z andrewinkler $
 * ============================================================================
...
public enum TeamType {
    ...
    public static List<TeamType> toList() {
        ...
        List<TeamType> listOfTeamTypes = new ArrayList<TeamType>();
        for (TeamType teamType : teamTypes) {
            listOfTeamTypes.add(teamType);
        }
        return listOfTeamTypes;
    }
